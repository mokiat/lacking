...
var _ = Describe("VisitorBucket", func() {
	Describe("zero value", func() {
		It("starts empty", func() {
			var bucket query3d.VisitorBucket[int]
	...
	Describe("NewVisitorBucket", func() {
		It("starts empty regardless of initial capacity", func() {
			bucket := query3d.NewVisitorBucket[int](64)
			Expect(bucket.Items()).To(BeEmpty())
		})
	})
	...
	Describe("Add", func() {
		It("appends items in order", func() {
			bucket := query3d.NewVisitorBucket[int](4)
			bucket.Add(10)
			bucket.Add(20)
			bucket.Add(30)
	...
	Describe("Items", func() {
		It("returns all added items as a slice", func() {
			bucket := query3d.NewVisitorBucket[string](4)
			bucket.Add("a")
			bucket.Add("b")
