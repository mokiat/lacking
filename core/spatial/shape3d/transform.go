...
// Transform represents a rigid-body transformation in 3D space, composed of a
...
func TRTransform(translation dprec.Vec3, rotation Rotation) Transform {
	return Transform{
		Translation: translation,
		Rotation:    rotation,
	}
...
func ChainedTransform(parent, child Transform) Transform {
	return Transform{
		...
		Rotation: Rotation{
			...
			BasisZ: parent.Rotation.Apply(child.Rotation.BasisZ),
		},
	}
}
...
func (t Transform) Inverse() Transform {
	...
	invTranslation := invRotation.Apply(dprec.InverseVec3(t.Translation))
	return Transform{
...
// translation.
func (t Transform) Apply(point dprec.Vec3) dprec.Vec3 {
	rotated := t.Rotation.Apply(point)
	return dprec.Vec3Sum(rotated, t.Translation)
}
