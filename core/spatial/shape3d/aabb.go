...
// EmptyAABB returns an [AABB] that represents an empty volume, suitable as
// the starting point for incrementally growing a bounding box (e.g. via
// repeated min/max updates as points are encountered).
func EmptyAABB() AABB {
	return AABB{
