// Package placement3d provides a 3D scene in which objects and terrains can be
// placed and tested for intersection.
//
// An object is a movable entity that owns one or more convex shapes (see
// [Scene.AttachSphere] and [Scene.AttachBox]). Moving the object through
...
//
// Object shapes and terrain shapes are indexed in separate octrees for
// efficient broad-phase queries. Narrow-phase intersection is resolved via
// GJK/EPA (see [github.com/mokiat/lacking/core/spatial/gjk3d]), with concave
