...
func (s *ResourceSet) convertMaterial(
	...
	materialInfo := graphics.MaterialInfo{
		...
		GeometryPasses: gog.Map(assetMaterial.GeometryPasses, func(pass dto.MaterialPass) graphics.MaterialPassInfo {
			return s.convertMaterialPass(shaders, pass)
		}),
		ShadowPasses: gog.Map(assetMaterial.ShadowPasses, func(pass dto.MaterialPass) graphics.MaterialPassInfo {
			return s.convertMaterialPass(shaders, pass)
		}),
		ForwardPasses: gog.Map(assetMaterial.ForwardPasses, func(pass dto.MaterialPass) graphics.MaterialPassInfo {
			return s.convertMaterialPass(shaders, pass)
		}),
		SkyPasses: gog.Map(assetMaterial.SkyPasses, func(pass dto.MaterialPass) graphics.MaterialPassInfo {
			return s.convertMaterialPass(shaders, pass)
		}),
		PostprocessingPasses: gog.Map(assetMaterial.PostprocessingPasses, func(pass dto.MaterialPass) graphics.MaterialPassInfo {
			return s.convertMaterialPass(shaders, pass)
		}),
	}
