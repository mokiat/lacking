...
func NewTonePostprocessingPresentation(api render.API, toneMapping ToneMapping) *PostprocessingPresentation {
	...
	return NewPostprocessingPresentation(api, vsBuilder.Build(), fsBuilder.Build())
}
