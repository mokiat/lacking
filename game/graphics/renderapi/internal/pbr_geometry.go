...
func NewPBRGeometryPresentation(api render.API, definition graphics.PBRMaterialDefinition) *GeometryPresentation {
	...
	return NewGeometryPresentation(api, vsBuilder.Build(), fsBuilder.Build())
}
